...
public enum CsvType {
    ...
    SevenCard("株式会社セブン・カードサービス","貸金","SJIS","","2019/1/21","2019/1/21"),
    LifeCard("ライフカード株式会社","貸金","SJIS","","2019/1/21","2019/1/21"),
    MitsuiSumitomoCard("三井住友カード株式会社","貸金","MS932","","2019/1/21","2019/1/21"),
    ;
